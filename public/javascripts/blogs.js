...
var Blogs = _react2.default.createClass({
    ...
    componentDidMount: function componentDidMount() {
        var _this = this;
        _jquery2.default.getJSON('/api/blogs.do', { limit: this.limit }, function (data, status) {
            _this.setState({
                data: data.list,
                status: data.status
            });
    ...
    searchBlogs: function searchBlogs() {
        var _this = this;
        this.key = (0, _jquery2.default)('.search_box').val();
        this.limit = 10;
        _jquery2.default.getJSON('/api/blogs.do', { limit: this.limit, key: this.key }, function (data, status) {
            _this.setState({
                data: data.list,
                status: data.status
            });
        ...
        return _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement("input", { type: "text", className: "search_box", placeholder: "关键词" }),
