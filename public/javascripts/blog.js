...
var Message = _react2.default.createClass({
    ...
    componentDidMount: function componentDidMount() {
        (0, _jquery2.default)(this.refs.messageContent).html('<div>' + this.props.item.content + '</div>');
    },
    render: function render() {
        return _react2.default.createElement(
            ...
            _react2.default.createElement("div", { className: "mContent", ref: "messageContent" }),
            _react2.default.createElement(
                "p",
                { className: "mTime" },
...
var Messages = _react2.default.createClass({
    ...
    componentDidMount: function componentDidMount() {
        var _this = this;
        _jquery2.default.getJSON('/message/get', { limit: this.limit, blogId: this.blogId }, function (data, status) {
            _this.setState({
                data: data.list,
                status: data.status,
                number: data.number
    ...
    submitMessage: function submitMessage() {
        ...
        _jquery2.default.getJSON('/message/add', message, function (data, status) {
            if (data && data.status) {
                _this.updateMessage();
            }
        });
    ...
    remenber: function remenber() {
        if (!this.refs.remember.checked) {
            localStorage.removeItem("fighting_un");
            localStorage.removeItem("fighting_ue");
        }
    },
    messageContentChange: function messageContentChange() {
        if (this.refs.messageContent.value === '') {
            this.refs.errorMc.innerHTML = '请填写您的看法!';
        } else {
    ...
    userEmailChange: function userEmailChange() {
        if (!this.isEmail.test(this.refs.userEmail.value)) {
            this.refs.errorUe.innerHTML = '请填写正确的邮箱!';
        } else {
    ...
    render: function render() {
        ...
        var moreMessages = void 0;
        if (this.state.status) {
            moreMessages = _react2.default.createElement(
                "span",
                { className: "moreMessages", onClick: this.loadMore },
                "更多留言..."
            );
        }
        return _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        null,
                        "您的留言 （HTML标签部分可用）",
                        _react2.default.createElement("span", { ref: "errorMc" })
                    ),
                    _react2.default.createElement("textarea", { ref: "messageContent", onChange: this.messageContentChange })
                ),
                _react2.default.createElement(
                    "div",
                    { className: "user_name" },
                    ...
                    _react2.default.createElement("input", { type: "text", ref: "userName", onChange: this.userNameChange }),
                    _react2.default.createElement(
                        "span",
                        null,
                        "必填"
                    ),
                    _react2.default.createElement("span", { ref: "errorUn" })
                ),
                _react2.default.createElement(
                    "div",
                    ...
                    _react2.default.createElement("input", { type: "text", ref: "userEmail", onChange: this.userEmailChange }),
                    _react2.default.createElement(
                        "span",
                        null,
                        "必填"
                    ),
                    _react2.default.createElement("span", { ref: "errorUe" })
                ),
                _react2.default.createElement(
                    "div",
                    { className: "remember" },
                    _react2.default.createElement(
                        ...
                        null,
                        "记住个人信息",
                        _react2.default.createElement("input", { type: "checkbox", ref: "remember", onClick: this.remenber })
                    )
                ),
                _react2.default.createElement(
                    "span",
                    { className: "submit", onClick: this.submitMessage },
                    "提交"
                )
            )
        );
...
var Blog = _react2.default.createClass({
    ...
    componentDidMount: function componentDidMount() {
        var _this = this;
        _jquery2.default.getJSON('/blog/getOne', { id: this.id }, function (data, status) {
            data[0].date = new Date(data[0].createTime).pattern("yyyy-MM-dd HH:mm:ss");
            _this.setState({
                data: data[0]
            });
            document.title = data[0].title + " -- Tong Xu's Personal Website";
            (0, _jquery2.default)(_this.refs.content).html('<div>' + data[0].con + '</div>');
        });
    },
    render: function render() {
        return _react2.default.createElement(
            ...
            _react2.default.createElement("div", { className: "blog_con", ref: "content" }),
